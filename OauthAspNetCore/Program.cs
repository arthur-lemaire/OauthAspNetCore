...
// Je l'ai laissé pour prouver sa faisabilité mais je préfère utiliser le SDK Firebase Admin(en Middleware) car il me permet d'avoir une seule config JSON en commun pour plusieurs projets et gérer d'autres points de sécurité facilement.
